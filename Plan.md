...
4. **Wiki-Bereich verbergen?** Messung G36 (schreibt auf die Testinstanz, vorher besprechen); die Mediathek als eigener Bereich steht (Punkt 16).
...
| **Gestalter** | Mitglieder von „Infoscreen-Designer" | **Inhalte der Slides**: Slides und Playlists anlegen, ändern, löschen; Bilder in den Wiki-Bereich „Infoscreen" laden. **Nicht:** Screens anlegen, löschen oder konfigurieren, Einstellungen, Kategorien, Rechte |
| **Gerät** | Mitglieder von „Infoscreen-Devices" | nur lesen: Modul, seine Daten, die Kalender der Screens |

Wer kein Administrator ist, sieht „Einstellungen" weder in der Kopfleiste noch in der Seitenleiste; ruft er die Adresse trotzdem auf, sagt die Seite, dass sie Sache der Administratoren ist. Das ist Bedienung, keine Sperre – die Sperre sind die Rechte selbst: Gestalter haben kein Schreibrecht auf `settings`, Geräte gar keines. **Entschieden am 2026-09-25: Screens konfigurieren nur Administratoren** – anlegen, löschen, Name, Format, Overscan, Zeitplan –, damit Gestalter die Screen-Konfiguration nicht beschädigen können; ein Screen steht für ein Gerät im Haus. **Noch nicht umgesetzt** (Punkt 15): Heute schreibt jedes Speichern im Editor auch den Index-Wert des Screens (Revision), und der Assistent gibt Gestaltern Schreibrechte auf `screens`.
