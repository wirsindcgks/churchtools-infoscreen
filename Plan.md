...
3. **Zeitpläne im Testsystem ausprobieren** (Nutzer) – Punkt 17 ist gebaut: Playlists und Regeln auf der Startseite (Kachel → „Zeitplan"), Vorschau je Tag.
...
| `playlists` | je Playlist ein Wert: Name, Reihenfolge der Slide-IDs; dazu **je Screen ein Zeitplan** (`kind: 'schedule'`, seit Schema 1.2): Standard-Playlist, Regeln, alle Playlists des Screens (1.3), eigene Revision – gehört den Gestaltern |
...
**Die Oberfläche ist seit dem 2026-09-25 gebaut (Punkt 17 der Nächsten Schritte); wählen dürfen sie die Gestalter.** **Entschieden am 2026-09-23:** Das Modell lautet **Screen → Playlist → Slides**. Die Ebene kommt in Phase 1 ins Schema, weil sie sich später nur mit einer Datenmigration auf laufenden Geräten nachziehen ließe. **Die Oberfläche dafür kommt später.** Im MVP hat jeder Screen genau eine Playlist, und der Gestalter merkt davon nichts.
