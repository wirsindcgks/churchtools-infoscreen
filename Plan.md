...
10. **Startseite überarbeiten** *(gewünscht am 2026-09-24)*: je Screen ein Vorschaubild seiner ersten Slide, damit man Screens auf einen Blick erkennt; ein Symbol für Hoch- oder Querformat; die Formularfelder einheitlich – das Auswahlfeld „Ausrichtung" ist niedriger als die Textfelder daneben.
11. **Designer leichter bedienbar** *(gewünscht am 2026-09-24)*: Farben auch als Hex-Wert eingeben, nicht nur über den Farbwähler des Browsers; unter der Slide-Liste ein „+" für eine neue Slide; die Bausteine sichtbarer machen – heute stehen sie als Knopfreihe in der Kopfzeile und gehen dort unter.
