...
11. **Designer leichter bedienbar** *(gewünscht am 2026-09-24)*: Farben auch als Hex-Wert eingeben, nicht nur über den Farbwähler des Browsers; unter der Slide-Liste ein „+" für eine neue Slide; die Bausteine sichtbarer machen – heute stehen sie als Knopfreihe in der Kopfzeile und gehen dort unter. Dazu die Bedienung am Handy: Blöcke mit dem Finger ziehen und skalieren, Inspektor als ausklappbares Blatt. **Kopfleiste des Editors neu** *(Idee vom 2026-09-24)*: Der Weg zurück („‹ Screens") geht zwischen Titel und Status unter – er soll deutlich sichtbar sein, etwa als eigener Knopf ganz links. Allgemein die Kopfleiste neu ordnen, gern nach dem Muster von ChurchTools: links Zurück und Titel, rechts wenige Hauptaktionen (Rückgängig/Wiederholen, Player, Speichern); die Bausteine gehören nicht in diese Leiste (siehe oben), das Raster in die Nähe der Bühne.
