...
10. **Release-Workflow** auf Tags `v*.*.*`, Versionsabgleich mit `CHANGELOG.md`, ZIP als GitHub-Release.
11. **Einrichtungsdoku** `docs/Einrichtung.md`: Klickwege, Kiosk-Browser, Notbremse (G18), Öffentlichkeit von Bildern und Logo (G14, G29).
12. **Freischaltung vorbereiten**: Skript für den Typ-Snapshot, das ohne `/custommodules`-Pfade abbricht; Checklisten für B6 und G9.
